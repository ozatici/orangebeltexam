...
describe('it should set up the game', () => {
    ...
    it('If a player makes a move on a square without any neighboring bombs, the squares around it should be automatically opened, recursively. If no bombs are hit, the game is won (UAT 6)', () => {
        let game = new src();
        game.start();
        game.setSolution([
            ["_", "1", "*"],
